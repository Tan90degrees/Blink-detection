...
class GetEar:
    ...
    def ear(self):
        ...
        for check in checks:
            ...
            cv.putText(self.video_frame, 'left_ear: {:.3f}'.format(left_ear), (10, 30), cv.FONT_HERSHEY_SIMPLEX, 0.75,
                       (255, 0, 0), 1)
            cv.putText(self.video_frame, 'right_ear: {:.3f}'.format(right_ear), (10, 50), cv.FONT_HERSHEY_SIMPLEX, 0.75,
                       (255, 0, 0), 1)
            cv.putText(self.video_frame, 'frame_count: {:d}'.format(self.frame_count), (250, 30),
                       cv.FONT_HERSHEY_SIMPLEX, 0.75, (255, 0, 0), 1)
